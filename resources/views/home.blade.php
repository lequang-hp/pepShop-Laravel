...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/pep/css/animate.css')}}">
    <link rel="stylesheet" href="{{asset('public/pep/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/pep/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/pep/css/magnific-popup.css')}}">

    <link rel="stylesheet" href="{{asset('public/pep/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('public/pep/css/jquery.timepicker.css')}}">
    <link rel="stylesheet" href="{{asset('public/pep/css/flaticon.css')}}">
    <link rel="stylesheet" href="{{asset('public/pep/css/style.css')}}">
</head>
<body>
<div class="wrap">
    <div class="container">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
            <div class="col-lg-6 pt-md-5 ftco-animate">
                <div class="mt-5">
                    ...
                    <p><a href="#" class="btn btn-primary py-3 px-4">Make An Appointment</a> <a href="#" class="btn btn-secondary py-3 px-4 font-weight-bold">11-234-5678-9102</a></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 d-flex align-self-stretch">
                <div class="d-block services d-flex justify-content-between">
                    ...
                    <div class="media-body">
                        <h3 class="heading">Pet Setting</h3>
                        <p class="mb-0">Far far away, behind the word mountains.</p>
                        <!-- <a href="#" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Read more</i></a> -->
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
            <div class="col-md-10 heading-section text-center ftco-animate">
                <span class="subheading">Blog Updates</span>
...
<script src="{{asset('public/pep/js/jquery.min.js')}}"></script>
<script src="{{asset('public/pep/js/jquery-migrate-3.0.1.min.js')}}"></script>
<script src="{{asset('public/pep/js/popper.min.js')}}"></script>
<script src="{{asset('public/pep/js/bootstrap.min.js')}}"></script>
<script src="{{asset('public/pep/js/jquery.easing.1.3.js')}}"></script>
<script src="{{asset('public/pep/js/jquery.waypoints.min.js')}}"></script>
<script src="{{asset('public/pep/js/jquery.stellar.min.js')}}"></script>
<script src="{{asset('public/pep/js/owl.carousel.min.js')}}"></script>
<script src="{{asset('public/pep/js/jquery.magnific-popup.min.js')}}"></script>
<script src="{{asset('public/pep/js/jquery.animateNumber.min.js')}}"></script>
<script src="{{asset('public/pep/js/bootstrap-datepicker.js')}}"></script>
<script src="{{asset('public/pep/js/jquery.timepicker.min.js')}}"></script>
<script src="{{asset('public/pep/js/scrollax.min.js')}}"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="{{asset('public/pep/js/google-map.js')}}"></script>
<script src="{{asset('public/pep/js/main.js')}}"></script>
</body>
</html>
